...
with open(sys.argv[1], 'r') as f:
    ...
    avg = 0
    for i in range(10):
        m = re.search(r'\[.*([0-9]{2,2}):([0-9]{2,2}):([0-9]{2,2})\.([0-9]{2,3})Z INFO  organ::client\] Sent ClientBaseMessage.\n\[.*([0-9]{2,2}):([0-9]{2,2}):([0-9]{2,2})\.([0-9]{2,3})Z INFO  organ::client\] Received ServerBaseMessage on round ' + str(i + 1), s)
